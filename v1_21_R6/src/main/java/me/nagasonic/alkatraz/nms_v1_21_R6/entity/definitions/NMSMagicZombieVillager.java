...
/**
 * Inert NMS scaffold for creating magic variants of {@code zombie_villager}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicZombieVillager extends ZombieVillager implements MagicEntity {
    ...
    protected NMSMagicZombieVillager(EntityType<? extends ZombieVillager> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicZombieVillager spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicZombieVillager mob = new NMSMagicZombieVillager(EntityType.ZOMBIE_VILLAGER, level, magicType);
