...
/**
 * Inert NMS scaffold for creating magic variants of {@code ravager}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicRavager extends Ravager implements MagicEntity {
    ...
    protected NMSMagicRavager(EntityType<? extends Ravager> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicRavager spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicRavager mob = new NMSMagicRavager(EntityType.RAVAGER, level, magicType);
