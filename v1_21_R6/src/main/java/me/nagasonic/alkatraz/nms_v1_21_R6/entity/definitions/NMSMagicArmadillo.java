...
/**
 * Inert NMS scaffold for creating magic variants of {@code armadillo}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicArmadillo extends Armadillo implements MagicEntity {
    ...
    protected NMSMagicArmadillo(EntityType<? extends Armadillo> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicArmadillo spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicArmadillo mob = new NMSMagicArmadillo(EntityType.ARMADILLO, level, magicType);
