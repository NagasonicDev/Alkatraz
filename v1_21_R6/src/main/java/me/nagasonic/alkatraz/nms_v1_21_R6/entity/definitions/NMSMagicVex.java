...
/**
 * Inert NMS scaffold for creating magic variants of {@code vex}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicVex extends Vex implements MagicEntity {
    ...
    protected NMSMagicVex(EntityType<? extends Vex> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicVex spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicVex mob = new NMSMagicVex(EntityType.VEX, level, magicType);
