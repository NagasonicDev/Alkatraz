...
/**
 * Inert NMS scaffold for creating magic variants of {@code wolf}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicWolf extends Wolf implements MagicEntity {
    ...
    protected NMSMagicWolf(EntityType<? extends Wolf> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicWolf spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicWolf mob = new NMSMagicWolf(EntityType.WOLF, level, magicType);
