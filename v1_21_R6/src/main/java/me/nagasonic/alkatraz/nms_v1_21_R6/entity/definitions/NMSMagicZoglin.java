...
/**
 * Inert NMS scaffold for creating magic variants of {@code zoglin}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicZoglin extends Zoglin implements MagicEntity {
    ...
    protected NMSMagicZoglin(EntityType<? extends Zoglin> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicZoglin spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicZoglin mob = new NMSMagicZoglin(EntityType.ZOGLIN, level, magicType);
