...
/**
 * Inert NMS scaffold for creating magic variants of {@code tadpole}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicTadpole extends Tadpole implements MagicEntity {
    ...
    protected NMSMagicTadpole(EntityType<? extends Tadpole> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicTadpole spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicTadpole mob = new NMSMagicTadpole(EntityType.TADPOLE, level, magicType);
