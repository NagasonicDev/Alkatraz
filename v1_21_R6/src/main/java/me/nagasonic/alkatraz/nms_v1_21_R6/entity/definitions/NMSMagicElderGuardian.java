...
/**
 * Inert NMS scaffold for creating magic variants of {@code elder_guardian}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicElderGuardian extends ElderGuardian implements MagicEntity {
    ...
    protected NMSMagicElderGuardian(EntityType<? extends ElderGuardian> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicElderGuardian spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicElderGuardian mob = new NMSMagicElderGuardian(EntityType.ELDER_GUARDIAN, level, magicType);
