...
/**
 * Inert NMS scaffold for creating magic variants of {@code creeper}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicCreeper extends Creeper implements MagicEntity {
    ...
    protected NMSMagicCreeper(EntityType<? extends Creeper> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicCreeper spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicCreeper mob = new NMSMagicCreeper(EntityType.CREEPER, level, magicType);
