...
/**
 * Inert NMS scaffold for creating magic variants of {@code strider}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicStrider extends Strider implements MagicEntity {
    ...
    protected NMSMagicStrider(EntityType<? extends Strider> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicStrider spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicStrider mob = new NMSMagicStrider(EntityType.STRIDER, level, magicType);
