...
/**
 * Inert NMS scaffold for creating magic variants of {@code snow_golem}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicSnowGolem extends SnowGolem implements MagicEntity {
    ...
    protected NMSMagicSnowGolem(EntityType<? extends SnowGolem> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicSnowGolem spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicSnowGolem mob = new NMSMagicSnowGolem(EntityType.SNOW_GOLEM, level, magicType);
