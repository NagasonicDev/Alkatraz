...
/**
 * Inert NMS scaffold for creating magic variants of {@code frog}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicFrog extends Frog implements MagicEntity {
    ...
    protected NMSMagicFrog(EntityType<? extends Frog> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicFrog spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicFrog mob = new NMSMagicFrog(EntityType.FROG, level, magicType);
