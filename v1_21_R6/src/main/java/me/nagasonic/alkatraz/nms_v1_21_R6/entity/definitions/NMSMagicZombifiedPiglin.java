package me.nagasonic.alkatraz.nms_v1_21_R6.entity.definitions;
...
/**
 * Inert NMS scaffold for creating magic variants of {@code zombified_piglin}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicZombifiedPiglin extends ZombifiedPiglin implements MagicEntity {
    ...
    protected NMSMagicZombifiedPiglin(EntityType<? extends ZombifiedPiglin> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicZombifiedPiglin spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicZombifiedPiglin mob = new NMSMagicZombifiedPiglin(EntityType.ZOMBIFIED_PIGLIN, level, magicType);
