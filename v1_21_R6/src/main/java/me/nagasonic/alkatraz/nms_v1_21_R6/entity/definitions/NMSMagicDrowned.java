...
/**
 * Inert NMS scaffold for creating magic variants of {@code drowned}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicDrowned extends Drowned implements MagicEntity {
    ...
    protected NMSMagicDrowned(EntityType<? extends Drowned> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicDrowned spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicDrowned mob = new NMSMagicDrowned(EntityType.DROWNED, level, magicType);
