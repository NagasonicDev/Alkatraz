...
/**
 * Inert NMS scaffold for creating magic variants of {@code cow}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicCow extends Cow implements MagicEntity {
    ...
    protected NMSMagicCow(EntityType<? extends Cow> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicCow spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicCow mob = new NMSMagicCow(EntityType.COW, level, magicType);
