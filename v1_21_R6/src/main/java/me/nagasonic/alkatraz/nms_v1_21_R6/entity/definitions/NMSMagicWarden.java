...
/**
 * Inert NMS scaffold for creating magic variants of {@code warden}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicWarden extends Warden implements MagicEntity {
    ...
    protected NMSMagicWarden(EntityType<? extends Warden> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicWarden spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicWarden mob = new NMSMagicWarden(EntityType.WARDEN, level, magicType);
