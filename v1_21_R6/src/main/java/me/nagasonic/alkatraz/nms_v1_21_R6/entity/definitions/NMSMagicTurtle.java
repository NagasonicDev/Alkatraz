...
/**
 * Inert NMS scaffold for creating magic variants of {@code turtle}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicTurtle extends Turtle implements MagicEntity {
    ...
    protected NMSMagicTurtle(EntityType<? extends Turtle> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicTurtle spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicTurtle mob = new NMSMagicTurtle(EntityType.TURTLE, level, magicType);
