...
/**
 * Inert NMS scaffold for creating magic variants of {@code cave_spider}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicCaveSpider extends CaveSpider implements MagicEntity {
    ...
    protected NMSMagicCaveSpider(EntityType<? extends CaveSpider> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicCaveSpider spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicCaveSpider mob = new NMSMagicCaveSpider(EntityType.CAVE_SPIDER, level, magicType);
