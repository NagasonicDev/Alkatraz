...
/**
 * Inert NMS scaffold for creating magic variants of {@code evoker}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicEvoker extends Evoker implements MagicEntity {
    ...
    protected NMSMagicEvoker(EntityType<? extends Evoker> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicEvoker spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicEvoker mob = new NMSMagicEvoker(EntityType.EVOKER, level, magicType);
