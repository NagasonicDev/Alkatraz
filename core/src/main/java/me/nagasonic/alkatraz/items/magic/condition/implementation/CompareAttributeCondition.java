...
public final class CompareAttributeCondition implements Condition {

    private final NamespacedKey attribute;
    private final Comparison comparison;
    private final double value;

    public CompareAttributeCondition(NamespacedKey attribute, Comparison comparison, double value) {
    ...
    public boolean test(TriggerContext context) {
        ...
        AttributeService attributes = MagicItemServices.attributes();
