...
/**
 * Inert NMS scaffold for creating magic variants of {@code phantom}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicPhantom extends Phantom implements MagicEntity {
    ...
    protected NMSMagicPhantom(EntityType<? extends Phantom> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicPhantom spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicPhantom mob = new NMSMagicPhantom(EntityType.PHANTOM, level, magicType);
