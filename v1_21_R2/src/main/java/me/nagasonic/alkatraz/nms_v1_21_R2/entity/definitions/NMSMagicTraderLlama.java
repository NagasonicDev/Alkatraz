...
/**
 * Inert NMS scaffold for creating magic variants of {@code trader_llama}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicTraderLlama extends TraderLlama implements MagicEntity {
    ...
    protected NMSMagicTraderLlama(EntityType<? extends TraderLlama> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicTraderLlama spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicTraderLlama mob = new NMSMagicTraderLlama(EntityType.TRADER_LLAMA, level, magicType);
