...
/**
 * Inert NMS scaffold for creating magic variants of {@code sheep}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicSheep extends Sheep implements MagicEntity {
    ...
    protected NMSMagicSheep(EntityType<? extends Sheep> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicSheep spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicSheep mob = new NMSMagicSheep(EntityType.SHEEP, level, magicType);
