...
/**
 * Inert NMS scaffold for creating magic variants of {@code shulker}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicShulker extends Shulker implements MagicEntity {
    ...
    protected NMSMagicShulker(EntityType<? extends Shulker> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicShulker spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicShulker mob = new NMSMagicShulker(EntityType.SHULKER, level, magicType);
