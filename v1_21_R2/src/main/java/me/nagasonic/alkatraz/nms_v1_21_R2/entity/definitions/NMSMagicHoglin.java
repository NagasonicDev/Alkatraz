...
/**
 * Inert NMS scaffold for creating magic variants of {@code hoglin}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicHoglin extends Hoglin implements MagicEntity {
    ...
    protected NMSMagicHoglin(EntityType<? extends Hoglin> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicHoglin spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicHoglin mob = new NMSMagicHoglin(EntityType.HOGLIN, level, magicType);
