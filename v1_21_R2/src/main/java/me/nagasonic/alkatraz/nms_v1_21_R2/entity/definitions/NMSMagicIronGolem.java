...
/**
 * Inert NMS scaffold for creating magic variants of {@code iron_golem}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicIronGolem extends IronGolem implements MagicEntity {
    ...
    protected NMSMagicIronGolem(EntityType<? extends IronGolem> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicIronGolem spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicIronGolem mob = new NMSMagicIronGolem(EntityType.IRON_GOLEM, level, magicType);
