...
/**
 * Inert NMS scaffold for creating magic variants of {@code silverfish}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicSilverfish extends Silverfish implements MagicEntity {
    ...
    protected NMSMagicSilverfish(EntityType<? extends Silverfish> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicSilverfish spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicSilverfish mob = new NMSMagicSilverfish(EntityType.SILVERFISH, level, magicType);
