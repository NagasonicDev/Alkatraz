...
/**
 * Inert NMS scaffold for creating magic variants of {@code slime}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicSlime extends Slime implements MagicEntity {
    ...
    protected NMSMagicSlime(EntityType<? extends Slime> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicSlime spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicSlime mob = new NMSMagicSlime(EntityType.SLIME, level, magicType);
