...
/**
 * Inert NMS scaffold for creating magic variants of {@code axolotl}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicAxolotl extends Axolotl implements MagicEntity {
    ...
    protected NMSMagicAxolotl(EntityType<? extends Axolotl> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicAxolotl spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicAxolotl mob = new NMSMagicAxolotl(EntityType.AXOLOTL, level, magicType);
