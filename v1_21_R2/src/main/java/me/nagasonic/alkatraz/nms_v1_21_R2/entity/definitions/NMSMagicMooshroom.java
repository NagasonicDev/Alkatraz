...
/**
 * Inert NMS scaffold for creating magic variants of {@code mooshroom}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicMooshroom extends MushroomCow implements MagicEntity {
    ...
    protected NMSMagicMooshroom(EntityType<? extends MushroomCow> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicMooshroom spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicMooshroom mob = new NMSMagicMooshroom(EntityType.MOOSHROOM, level, magicType);
