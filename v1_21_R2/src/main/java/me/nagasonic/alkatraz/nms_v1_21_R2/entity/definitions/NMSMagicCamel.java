...
/**
 * Inert NMS scaffold for creating magic variants of {@code camel}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicCamel extends Camel implements MagicEntity {
    ...
    protected NMSMagicCamel(EntityType<? extends Camel> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicCamel spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicCamel mob = new NMSMagicCamel(EntityType.CAMEL, level, magicType);
