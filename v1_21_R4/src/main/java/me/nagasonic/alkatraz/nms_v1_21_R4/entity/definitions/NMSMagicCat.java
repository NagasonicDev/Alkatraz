...
/**
 * Inert NMS scaffold for creating magic variants of {@code cat}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicCat extends Cat implements MagicEntity {
    ...
    protected NMSMagicCat(EntityType<? extends Cat> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicCat spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicCat mob = new NMSMagicCat(EntityType.CAT, level, magicType);
