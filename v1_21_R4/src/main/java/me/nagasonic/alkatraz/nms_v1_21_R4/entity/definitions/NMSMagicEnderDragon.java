...
/**
 * Inert NMS scaffold for creating magic variants of {@code ender_dragon}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicEnderDragon extends EnderDragon implements MagicEntity {
    ...
    protected NMSMagicEnderDragon(EntityType<? extends EnderDragon> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicEnderDragon spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicEnderDragon mob = new NMSMagicEnderDragon(EntityType.ENDER_DRAGON, level, magicType);
