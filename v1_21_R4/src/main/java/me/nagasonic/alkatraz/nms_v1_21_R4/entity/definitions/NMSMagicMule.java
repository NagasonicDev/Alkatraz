...
/**
 * Inert NMS scaffold for creating magic variants of {@code mule}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicMule extends Mule implements MagicEntity {
    ...
    protected NMSMagicMule(EntityType<? extends Mule> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicMule spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicMule mob = new NMSMagicMule(EntityType.MULE, level, magicType);
