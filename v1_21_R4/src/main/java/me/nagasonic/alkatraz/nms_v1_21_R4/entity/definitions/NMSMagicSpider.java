...
/**
 * Inert NMS scaffold for creating magic variants of {@code spider}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicSpider extends Spider implements MagicEntity {
    ...
    protected NMSMagicSpider(EntityType<? extends Spider> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicSpider spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicSpider mob = new NMSMagicSpider(EntityType.SPIDER, level, magicType);
