...
/**
 * Inert NMS scaffold for creating magic variants of {@code magma_cube}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicMagmaCube extends MagmaCube implements MagicEntity {
    ...
    protected NMSMagicMagmaCube(EntityType<? extends MagmaCube> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicMagmaCube spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicMagmaCube mob = new NMSMagicMagmaCube(EntityType.MAGMA_CUBE, level, magicType);
