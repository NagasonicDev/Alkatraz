...
/**
 * Inert NMS scaffold for creating magic variants of {@code ocelot}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicOcelot extends Ocelot implements MagicEntity {
    ...
    protected NMSMagicOcelot(EntityType<? extends Ocelot> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicOcelot spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicOcelot mob = new NMSMagicOcelot(EntityType.OCELOT, level, magicType);
