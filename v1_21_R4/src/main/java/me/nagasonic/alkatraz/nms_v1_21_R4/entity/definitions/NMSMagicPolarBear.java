...
/**
 * Inert NMS scaffold for creating magic variants of {@code polar_bear}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicPolarBear extends PolarBear implements MagicEntity {
    ...
    protected NMSMagicPolarBear(EntityType<? extends PolarBear> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicPolarBear spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicPolarBear mob = new NMSMagicPolarBear(EntityType.POLAR_BEAR, level, magicType);
