...
/**
 * Inert NMS scaffold for creating magic variants of {@code bogged}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicBogged extends Bogged implements MagicEntity {
    ...
    protected NMSMagicBogged(EntityType<? extends Bogged> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicBogged spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicBogged mob = new NMSMagicBogged(EntityType.BOGGED, level, magicType);
