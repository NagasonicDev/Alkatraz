...
/**
 * Inert NMS scaffold for creating magic variants of {@code vindicator}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicVindicator extends Vindicator implements MagicEntity {
    ...
    protected NMSMagicVindicator(EntityType<? extends Vindicator> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicVindicator spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicVindicator mob = new NMSMagicVindicator(EntityType.VINDICATOR, level, magicType);
