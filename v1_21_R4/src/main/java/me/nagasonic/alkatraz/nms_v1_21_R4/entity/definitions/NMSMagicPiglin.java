...
/**
 * Inert NMS scaffold for creating magic variants of {@code piglin}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicPiglin extends Piglin implements MagicEntity {
    ...
    protected NMSMagicPiglin(EntityType<? extends Piglin> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicPiglin spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicPiglin mob = new NMSMagicPiglin(EntityType.PIGLIN, level, magicType);
