...
/**
 * Inert NMS scaffold for creating magic variants of {@code panda}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicPanda extends Panda implements MagicEntity {
    ...
    protected NMSMagicPanda(EntityType<? extends Panda> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicPanda spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicPanda mob = new NMSMagicPanda(EntityType.PANDA, level, magicType);
