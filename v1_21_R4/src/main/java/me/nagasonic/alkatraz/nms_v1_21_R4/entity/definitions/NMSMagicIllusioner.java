...
/**
 * Inert NMS scaffold for creating magic variants of {@code illusioner}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicIllusioner extends Illusioner implements MagicEntity {
    ...
    protected NMSMagicIllusioner(EntityType<? extends Illusioner> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicIllusioner spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicIllusioner mob = new NMSMagicIllusioner(EntityType.ILLUSIONER, level, magicType);
