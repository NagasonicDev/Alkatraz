...
/**
 * Inert NMS scaffold for creating magic variants of {@code fox}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicFox extends Fox implements MagicEntity {
    ...
    protected NMSMagicFox(EntityType<? extends Fox> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicFox spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicFox mob = new NMSMagicFox(EntityType.FOX, level, magicType);
