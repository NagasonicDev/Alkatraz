...
/**
 * Inert NMS scaffold for creating magic variants of {@code sniffer}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicSniffer extends Sniffer implements MagicEntity {
    ...
    protected NMSMagicSniffer(EntityType<? extends Sniffer> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicSniffer spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicSniffer mob = new NMSMagicSniffer(EntityType.SNIFFER, level, magicType);
