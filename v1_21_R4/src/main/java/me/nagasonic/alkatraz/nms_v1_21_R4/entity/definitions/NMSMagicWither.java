...
/**
 * Inert NMS scaffold for creating magic variants of {@code wither}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicWither extends WitherBoss implements MagicEntity {
    ...
    protected NMSMagicWither(EntityType<? extends WitherBoss> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicWither spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicWither mob = new NMSMagicWither(EntityType.WITHER, level, magicType);
