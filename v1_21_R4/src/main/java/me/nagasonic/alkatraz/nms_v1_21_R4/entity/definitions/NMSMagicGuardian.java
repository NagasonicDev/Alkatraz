...
/**
 * Inert NMS scaffold for creating magic variants of {@code guardian}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicGuardian extends Guardian implements MagicEntity {
    ...
    protected NMSMagicGuardian(EntityType<? extends Guardian> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicGuardian spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicGuardian mob = new NMSMagicGuardian(EntityType.GUARDIAN, level, magicType);
