...
/**
 * Inert NMS scaffold for creating magic variants of {@code allay}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicAllay extends Allay implements MagicEntity {
    ...
    protected NMSMagicAllay(EntityType<? extends Allay> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicAllay spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicAllay mob = new NMSMagicAllay(EntityType.ALLAY, level, magicType);
