package me.nagasonic.alkatraz.nms_v1_21_R4.entity.definitions;
...
/**
 * Inert NMS scaffold for creating magic variants of {@code wandering_trader}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicWanderingTrader extends WanderingTrader implements MagicEntity {
    ...
    protected NMSMagicWanderingTrader(EntityType<? extends WanderingTrader> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicWanderingTrader spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicWanderingTrader mob = new NMSMagicWanderingTrader(EntityType.WANDERING_TRADER, level, magicType);
