...
/**
 * Inert NMS scaffold for creating magic variants of {@code breeze}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicBreeze extends Breeze implements MagicEntity {
    ...
    protected NMSMagicBreeze(EntityType<? extends Breeze> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicBreeze spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicBreeze mob = new NMSMagicBreeze(EntityType.BREEZE, level, magicType);
