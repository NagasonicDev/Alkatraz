...
/**
 * Inert NMS scaffold for creating magic variants of {@code skeleton_horse}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicSkeletonHorse extends SkeletonHorse implements MagicEntity {
    ...
    protected NMSMagicSkeletonHorse(EntityType<? extends SkeletonHorse> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicSkeletonHorse spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicSkeletonHorse mob = new NMSMagicSkeletonHorse(EntityType.SKELETON_HORSE, level, magicType);
