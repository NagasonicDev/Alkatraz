...
/**
 * Inert NMS scaffold for creating magic variants of {@code zombie_horse}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicZombieHorse extends ZombieHorse implements MagicEntity {
    ...
    protected NMSMagicZombieHorse(EntityType<? extends ZombieHorse> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicZombieHorse spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicZombieHorse mob = new NMSMagicZombieHorse(EntityType.ZOMBIE_HORSE, level, magicType);
