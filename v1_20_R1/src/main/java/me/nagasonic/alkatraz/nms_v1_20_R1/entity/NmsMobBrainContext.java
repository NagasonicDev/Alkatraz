...
public final class NmsMobBrainContext implements MobBrainContext {
    ...
    public void setTarget(LivingEntity target) {
        mob.setTarget(target != null ? (net.minecraft.world.entity.LivingEntity) ((org.bukkit.craftbukkit.v1_20_R1.entity.CraftLivingEntity) target).getHandle() : null);
    }
    ...
    public boolean hasLineOfSight(Entity entity) {
        if (entity instanceof org.bukkit.craftbukkit.v1_20_R1.entity.CraftEntity craftEntity) {
    ...
    public double distanceSq(Entity entity) {
        return mob.distanceToSqr(((org.bukkit.craftbukkit.v1_20_R1.entity.CraftEntity) entity).getHandle());
    }

    @Override
    public ItemStack getMainHandItem() {
        return org.bukkit.craftbukkit.v1_20_R1.inventory.CraftItemStack.asBukkitCopy(mob.getMainHandItem());
    }
