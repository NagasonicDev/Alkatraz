...
public final class NmsMobBrainContext implements MobBrainContext {
    ...
    public void setTarget(LivingEntity target) {
        mob.setTarget(target != null ? (net.minecraft.world.entity.LivingEntity) ((org.bukkit.craftbukkit.entity.CraftLivingEntity) target).getHandle() : null);
    }
    ...
    public double distanceSq(Entity entity) {
        return mob.distanceToSqr(((org.bukkit.craftbukkit.entity.CraftEntity) entity).getHandle());
    }

    @Override
    public ItemStack getMainHandItem() {
        return org.bukkit.craftbukkit.inventory.CraftItemStack.asBukkitCopy(mob.getMainHandItem());
    }
