package me.nagasonic.alkatraz.nms_v26_R2.entity.implementation;
...
import me.nagasonic.alkatraz.nms_v26_R2.entity.definitions.NMSMagicZombie;
...
public final class ZombieFighter extends NMSMagicZombie {
    ...
    public static ZombieFighter spawn(Location location) {
        ...
        ZombieFighter zombie = new ZombieFighter(EntityTypes.ZOMBIE, level);
