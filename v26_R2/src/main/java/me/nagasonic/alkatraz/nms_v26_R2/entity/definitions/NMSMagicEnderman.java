...
/**
 * Inert NMS scaffold for creating magic variants of {@code enderman}. Identity and AI
...
public class NMSMagicEnderman extends EnderMan implements MagicEntity {
    ...
    public static NMSMagicEnderman spawn(MagicEntityType magicType, Location location) {
        ...
        NMSMagicEnderman mob = new NMSMagicEnderman(EntityTypes.ENDERMAN, level, magicType);
