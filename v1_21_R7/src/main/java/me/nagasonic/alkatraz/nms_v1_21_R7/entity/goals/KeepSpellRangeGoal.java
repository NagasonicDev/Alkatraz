package me.nagasonic.alkatraz.nms_v1_21_R7.entity.goals;
 ...
 * target. The mob will:
 *
 *  â€¢ Back away if the target is closer than {@code minDistance}.
 *  â€¢ Walk toward the target if it is farther than {@code maxDistance}.
 *  â€¢ Stop moving and hold position while inside the preferred band, letting
 ...
 *   1 â€” SwimGoal
 *   2 â€” GoalKeepSpellRange   â† insert here
 *   3 â€” GoalCastSpell
 *   4 â€” vanilla look/stroll goals
 */
public class KeepSpellRangeGoal extends Goal {
    ...
    public KeepSpellRangeGoal(Mob mob, double minDistance, double maxDistance, double speed) {
        ...
        // MOVE â€” we reposition; LOOK is intentionally left out so GoalCastSpell
    ...
    public void tick() {
        ...
        if (distSq < minDistance * minDistance) {
            // Too close â€” strafe backward away from target
            strafeAwayFrom(target);
        } else {
            // Too far â€” path toward target, stopping at maxDistance
