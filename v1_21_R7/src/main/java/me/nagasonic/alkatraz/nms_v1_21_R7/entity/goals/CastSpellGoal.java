...
public class CastSpellGoal extends Goal {
    ...
    public boolean canContinueToUse() {
        ...
        // Only stay active during the wind-up.
        // Once the spell fires, the goal yields and melee AI can take over.
    ...
    public void stop() {
        ...
        // DO NOT reset cooldown here.
        // We want melee goals to run while waiting.
    }
    ...
    private void fireCast() {
        ...
        if (item.getType() != Material.AIR && WandUtils.isWand(item)) {
            wand = item;
        } else {
            wand = null;
        }
