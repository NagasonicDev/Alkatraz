...
import me.nagasonic.alkatraz.nms_v1_21_R7.entity.definitions.NMSMagicZombie;
...
public final class ZombieFighter extends NMSMagicZombie {
    ...
    // minCastDist / maxCastDist = 0 â†’ KeepSpellRangeGoal is skipped.
    ...
    // -------------------------------------------------------------------------
    // Extra goals â€” villager and iron golem targeting (zombie-specific)
    // -------------------------------------------------------------------------

    /**
     * ZombieFighter retains vanilla zombie aggression toward villagers and iron
     * golems. These are registered after {@link me.nagasonic.alkatraz.nms_v1_21_R7.entity.GoalBuilder}
     * populates the standard targets, so priorities are relative to what is
     * already there (HurtBy=1, Player=2 â†’ these start at 3).
     */
    @Override
    ...
    public net.minecraft.network.chat.Component getDisplayName() {
        return net.minecraft.network.chat.Component.literal("Â§8Zombie Fighter");
    }
}
