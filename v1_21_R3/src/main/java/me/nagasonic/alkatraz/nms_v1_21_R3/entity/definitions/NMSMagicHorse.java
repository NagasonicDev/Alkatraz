...
/**
 * Inert NMS scaffold for creating magic variants of {@code horse}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicHorse extends Horse implements MagicEntity {
    ...
    protected NMSMagicHorse(EntityType<? extends Horse> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicHorse spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicHorse mob = new NMSMagicHorse(EntityType.HORSE, level, magicType);
