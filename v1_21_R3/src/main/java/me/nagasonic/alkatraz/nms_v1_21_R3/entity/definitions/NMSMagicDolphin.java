...
/**
 * Inert NMS scaffold for creating magic variants of {@code dolphin}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicDolphin extends Dolphin implements MagicEntity {
    ...
    protected NMSMagicDolphin(EntityType<? extends Dolphin> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicDolphin spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicDolphin mob = new NMSMagicDolphin(EntityType.DOLPHIN, level, magicType);
