...
/**
 * Inert NMS scaffold for creating magic variants of {@code bee}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicBee extends Bee implements MagicEntity {
    ...
    protected NMSMagicBee(EntityType<? extends Bee> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicBee spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicBee mob = new NMSMagicBee(EntityType.BEE, level, magicType);
