...
/**
 * Inert NMS scaffold for creating magic variants of {@code chicken}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicChicken extends Chicken implements MagicEntity {
    ...
    protected NMSMagicChicken(EntityType<? extends Chicken> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicChicken spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicChicken mob = new NMSMagicChicken(EntityType.CHICKEN, level, magicType);
