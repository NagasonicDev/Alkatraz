...
/**
 * Inert NMS scaffold for creating magic variants of {@code piglin_brute}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicPiglinBrute extends PiglinBrute implements MagicEntity {
    ...
    protected NMSMagicPiglinBrute(EntityType<? extends PiglinBrute> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicPiglinBrute spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicPiglinBrute mob = new NMSMagicPiglinBrute(EntityType.PIGLIN_BRUTE, level, magicType);
