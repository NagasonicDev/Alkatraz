...
/**
 * Inert NMS scaffold for creating magic variants of {@code blaze}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicBlaze extends Blaze implements MagicEntity {
    ...
    protected NMSMagicBlaze(EntityType<? extends Blaze> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicBlaze spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicBlaze mob = new NMSMagicBlaze(EntityType.BLAZE, level, magicType);
