...
/**
 * Inert NMS scaffold for creating magic variants of {@code goat}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicGoat extends Goat implements MagicEntity {
    ...
    protected NMSMagicGoat(EntityType<? extends Goat> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicGoat spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicGoat mob = new NMSMagicGoat(EntityType.GOAT, level, magicType);
