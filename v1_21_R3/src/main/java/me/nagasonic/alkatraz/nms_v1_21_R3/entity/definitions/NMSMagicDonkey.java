...
/**
 * Inert NMS scaffold for creating magic variants of {@code donkey}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicDonkey extends Donkey implements MagicEntity {
    ...
    protected NMSMagicDonkey(EntityType<? extends Donkey> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicDonkey spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicDonkey mob = new NMSMagicDonkey(EntityType.DONKEY, level, magicType);
