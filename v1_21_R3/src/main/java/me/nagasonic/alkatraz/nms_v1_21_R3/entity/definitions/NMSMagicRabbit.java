...
/**
 * Inert NMS scaffold for creating magic variants of {@code rabbit}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicRabbit extends Rabbit implements MagicEntity {
    ...
    protected NMSMagicRabbit(EntityType<? extends Rabbit> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    @Override
    public final void registerGoals() {
    ...
    public static NMSMagicRabbit spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicRabbit mob = new NMSMagicRabbit(EntityType.RABBIT, level, magicType);
