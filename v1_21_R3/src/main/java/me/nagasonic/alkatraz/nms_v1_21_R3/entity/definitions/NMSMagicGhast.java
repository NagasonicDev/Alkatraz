...
/**
 * Inert NMS scaffold for creating magic variants of {@code ghast}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicGhast extends Ghast implements MagicEntity {
    ...
    protected NMSMagicGhast(EntityType<? extends Ghast> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicGhast spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicGhast mob = new NMSMagicGhast(EntityType.GHAST, level, magicType);
