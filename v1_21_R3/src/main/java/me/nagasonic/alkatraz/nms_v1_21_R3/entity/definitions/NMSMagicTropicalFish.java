...
/**
 * Inert NMS scaffold for creating magic variants of {@code tropical_fish}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicTropicalFish extends TropicalFish implements MagicEntity {
    ...
    protected NMSMagicTropicalFish(EntityType<? extends TropicalFish> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicTropicalFish spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicTropicalFish mob = new NMSMagicTropicalFish(EntityType.TROPICAL_FISH, level, magicType);
