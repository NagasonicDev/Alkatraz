...
/**
 * Inert NMS scaffold for creating magic variants of {@code husk}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicHusk extends Husk implements MagicEntity {
    ...
    protected NMSMagicHusk(EntityType<? extends Husk> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicHusk spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicHusk mob = new NMSMagicHusk(EntityType.HUSK, level, magicType);
