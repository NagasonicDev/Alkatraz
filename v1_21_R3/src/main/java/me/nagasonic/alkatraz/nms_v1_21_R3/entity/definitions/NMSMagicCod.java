...
/**
 * Inert NMS scaffold for creating magic variants of {@code cod}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicCod extends Cod implements MagicEntity {
    ...
    protected NMSMagicCod(EntityType<? extends Cod> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicCod spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicCod mob = new NMSMagicCod(EntityType.COD, level, magicType);
