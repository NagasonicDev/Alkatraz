...
/**
 * Inert NMS scaffold for creating magic variants of {@code witch}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicWitch extends Witch implements MagicEntity {
    ...
    protected NMSMagicWitch(EntityType<? extends Witch> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicWitch spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicWitch mob = new NMSMagicWitch(EntityType.WITCH, level, magicType);
