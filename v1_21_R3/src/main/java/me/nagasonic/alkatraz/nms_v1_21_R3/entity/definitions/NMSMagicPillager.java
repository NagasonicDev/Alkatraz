...
/**
 * Inert NMS scaffold for creating magic variants of {@code pillager}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicPillager extends Pillager implements MagicEntity {
    ...
    protected NMSMagicPillager(EntityType<? extends Pillager> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicPillager spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicPillager mob = new NMSMagicPillager(EntityType.PILLAGER, level, magicType);
