...
/**
 * Inert NMS scaffold for creating magic variants of {@code parrot}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicParrot extends Parrot implements MagicEntity {
    ...
    protected NMSMagicParrot(EntityType<? extends Parrot> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicParrot spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicParrot mob = new NMSMagicParrot(EntityType.PARROT, level, magicType);
