...
/**
 * Inert NMS scaffold for creating magic variants of {@code pig}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicPig extends Pig implements MagicEntity {
    ...
    protected NMSMagicPig(EntityType<? extends Pig> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicPig spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicPig mob = new NMSMagicPig(EntityType.PIG, level, magicType);
