...
/**
 * Inert NMS scaffold for creating magic variants of {@code villager}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicVillager extends Villager implements MagicEntity {
    ...
    protected NMSMagicVillager(EntityType<? extends Villager> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicVillager spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicVillager mob = new NMSMagicVillager(EntityType.VILLAGER, level, magicType);
