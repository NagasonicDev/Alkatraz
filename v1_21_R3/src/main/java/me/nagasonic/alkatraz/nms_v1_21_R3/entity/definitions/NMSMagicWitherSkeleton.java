...
/**
 * Inert NMS scaffold for creating magic variants of {@code wither_skeleton}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicWitherSkeleton extends WitherSkeleton implements MagicEntity {
    ...
    protected NMSMagicWitherSkeleton(EntityType<? extends WitherSkeleton> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicWitherSkeleton spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicWitherSkeleton mob = new NMSMagicWitherSkeleton(EntityType.WITHER_SKELETON, level, magicType);
