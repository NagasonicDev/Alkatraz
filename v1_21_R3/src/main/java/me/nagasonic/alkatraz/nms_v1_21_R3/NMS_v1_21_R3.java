package me.nagasonic.alkatraz.nms_v1_21_R3;
import me.nagasonic.alkatraz.nms.NMS;
import me.nagasonic.alkatraz.nms_v1_21_R3.entity.AiSpecRegistration;
import me.nagasonic.alkatraz.nms_v1_21_R3.entity.GoalBridge;
import me.nagasonic.alkatraz.nms_v1_21_R3.entity.NmsMobBrainContext;
...
import me.nagasonic.alkatraz.nms_v1_21_R3.entity.MagicEntitySpawner;
...
public final class NMS_v1_21_R3 implements NMS {
    ...
    public void fakeArmor(HumanEntity e, Player target, org.bukkit.inventory.ItemStack helmet, org.bukkit.inventory.ItemStack chest, org.bukkit.inventory.ItemStack legs, org.bukkit.inventory.ItemStack boots) {
        ...
        java.util.function.Function<org.bukkit.inventory.ItemStack, ItemStack> toNms =
                (item) -> item != null ? org.bukkit.craftbukkit.v1_21_R3.inventory.CraftItemStack.asNMSCopy(item) : ItemStack.EMPTY;
    ...
    public void refresh(Player player) {
        ...
        int teleportId = nmsPlayer.serverLevel().getServer().getTickCount();
