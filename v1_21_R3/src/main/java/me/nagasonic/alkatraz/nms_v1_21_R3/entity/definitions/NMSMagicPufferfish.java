...
/**
 * Inert NMS scaffold for creating magic variants of {@code pufferfish}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicPufferfish extends Pufferfish implements MagicEntity {
    ...
    protected NMSMagicPufferfish(EntityType<? extends Pufferfish> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicPufferfish spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicPufferfish mob = new NMSMagicPufferfish(EntityType.PUFFERFISH, level, magicType);
