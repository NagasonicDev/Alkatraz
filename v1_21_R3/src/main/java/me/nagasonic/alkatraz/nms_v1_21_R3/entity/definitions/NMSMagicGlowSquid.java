...
/**
 * Inert NMS scaffold for creating magic variants of {@code glow_squid}. Identity and AI
 * come from core ({@link MagicBrains}) keyed by the stored {@link MagicEntityType}.
 */
public class NMSMagicGlowSquid extends GlowSquid implements MagicEntity {
    ...
    protected NMSMagicGlowSquid(EntityType<? extends GlowSquid> type, Level level, MagicEntityType magicType) {
        super(type, level);
    ...
    public static NMSMagicGlowSquid spawn(MagicEntityType magicType, Location location) {
        ServerLevel level = ((CraftWorld) location.getWorld()).getHandle();

        NMSMagicGlowSquid mob = new NMSMagicGlowSquid(EntityType.GLOW_SQUID, level, magicType);
